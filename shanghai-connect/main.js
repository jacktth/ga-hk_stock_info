...
var shConnectListingEng = "https://www.hkex.com.hk/-/media/HKEX-Market/Mutual-Market/Stock-Connect/Eligible-Stocks/View-All-Eligible-Securities_xls/SSE_Securities.xls";
var shConnectListingZh = "https://www.hkex.com.hk/-/media/HKEX-Market/Mutual-Market/Stock-Connect/Eligible-Stocks/View-All-Eligible-Securities_xls/SSE_Securities_c.xls";
var zhResult = fetch(shConnectListingZh).then(function (data) {
...
var fetching = fetch(shConnectListingEng).then(function (data) {
    var arrayBuffer = data.arrayBuffer().then(function (data) {
        var wb = XLSX.read(data);
        var ws = wb.Sheets[wb.SheetNames[0]];
        var beginRow = 1;
